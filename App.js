...
export default class App extends React.Component {
  ...
  gameResult = (pressedKey) => {
    ...
    if(this.state.characters[index - 1] === selectedCharacter) matches += 1

    if(this.state.characters[index + 1] === selectedCharacter) matches += 1

    if(this.state.characters[index + 3] === selectedCharacter) matches += 1
  ...
  componentDidMount = () => this.generateCharacters()
